# CARE: A Tuning-Free, Do-No-Harm Acceptance and Repair Layer for Anytime MAPF

Reproducibility package for the paper *CARE: A Tuning-Free, Do-No-Harm Acceptance and Repair
Layer for Anytime Multi-Agent Path Finding*. CARE is a thin, environment-gated **acceptance +
repair layer** injected into five generations of MAPF-LNS solvers, leaving the destroy operator
unchanged. It is evaluated with strict within-instance pairing, a preregistered do-no-harm
protocol calibrated to the measured solver-noise floor, an anytime (t=300 s) drift study, and a
zero-shot generalization suite on 178 procedurally generated maps — a **146,660-run** study.

- **Frozen experimental design / preregistration:** [`PREREGISTRATION.md`](PREREGISTRATION.md)
- **Aggregated per-cell results backing every table/figure:** [`results/`](results/)
...
results/           aggregated per-cell tables backing the paper's tables and figures
...
anytime Δ(t) tables, and generated-map per-family ECDFs. The aggregated tables that back every
number in the paper are provided under [`results/`](results/) with a per-file guide in
[`results/README.md`](results/README.md).

## Citation

```bibtex
@inproceedings{care2027,
  title     = {CARE: A Tuning-Free, Do-No-Harm Acceptance and Repair Layer for Anytime Multi-Agent Path Finding},
  author    = {The CARE Authors},

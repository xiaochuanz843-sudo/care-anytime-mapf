...
// ---- L2_REPAIR_PORT: file-static repair-order-bandit state (safe-arm-set delayed replan-priority bandit) ----
...
// DEFAULT arm set "0,2,3,4" EXCLUDES arm 1 (catastrophic on our fork); override with L2_RB_ARMS.
...
static bool   g_rb2_allow[5] = {true,false,true,true,true};   // default L2_RB_ARMS="0,2,3,4" (safe arm set)
